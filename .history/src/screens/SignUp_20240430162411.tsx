...
export default function SignUp({navigation}:any){
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      autoCapitalize='none' />
          <TextInput style={styles.input} placeholder='EMAIL' onChangeText={(UserEmail) => setUserName(UserEmail)} autoCorrect={false}
      autoCapitalize='none' />
          <TextInput style={styles.input} placeholder='PHONE NUMBER' onChangeText={(UserPhone) => setUserName(UserPhone)} autoCorrect={false}
      autoCapitalize='none' />
