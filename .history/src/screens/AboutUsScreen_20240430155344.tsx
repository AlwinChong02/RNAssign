...
const facebookURL = 'www.google.com/';
const instaURL = 'www.instagram.com/utarnet1/';
const ytbURL = 'www.youtube.com/@UtarEduMy';
            ...
            <View style={{ padding: 10 }}>
                ...
                <View>
                    <View style={styles.urlContainer}>
                        ...
                        <OpenURLButton url={facebookURL}>UTAR Recipe FB            </OpenURLButton>
                    </View>
                    <View style={styles.urlContainer}>
                        <Ionicons name='logo-instagram' size={40} color="#cd486b" paddingHorizontal={20} marginRight={30} />
                        <OpenURLButton url={instaURL}>UTAR Recipe IG             </OpenURLButton>
                    </View>
                    <View style={styles.urlContainer}>
                        <Ionicons name='logo-youtube' size={40} color="red" paddingHorizontal={20} marginRight={30} />
                        <OpenURLButton url={ytbURL}>UTAR Recipe YT            </OpenURLButton>
                    </View>
