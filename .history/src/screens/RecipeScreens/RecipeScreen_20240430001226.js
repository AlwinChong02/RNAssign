...
import { Alert, View, Text, Image, ScrollView, StyleSheet, Button, ActivityIndicator, TouchableOpacity } from 'react-native';
...
const RecipeScreen = ({ route }) => {
    ...
    useEffect(() => {
        if (!recipeId) {
            Alert.alert('Error', 'Invalid recipe ID. Please try again.');
            return;
        }
